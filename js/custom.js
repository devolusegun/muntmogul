(function ($) {
    ...
    jQuery(document).ready(function ($) {
        ...
        $(document).ready(function () {
                ...
                $.ajax({
                    ...
                    success: function (response) {
                        if (response.success) {
                            ...
                            $("#ticketTable tbody").html(ticketsHtml);
                        } else {
                            $("#ticketTable tbody").html('<tr><td colspan="4">No tickets found.</td></tr>');
                        }
                    },
                    error: function () {
            ...
            fetchTickets(); // Call function on page load
        });
