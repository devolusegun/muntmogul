...
<head>
    <meta charset="utf-8" />
    <title>Dashboard | All Transactions</title>
    ...
    <div class="l-sidebar">
        <div class="l-sidebar__content">
            <nav class="c-menu js-menu" id="mynavi">
                    ...
                    <li class="crm_navi_icon">
                        <div class="c-menu__item__inner"><a href="depositupload"><i
                            ...
                            <ul class="crm_hover_menu">
                                ...
                                <li><a href="#"> <i class="fa fa-circle"></i>all transactions</a> </li>
                ...
                <ul class="u-list crm_drop_second_ul">
                    <li class="crm_navi_icon">
                        <div class="c-menu__item__inner"><a href="investment"><i class="flaticon-file"></i></a>
                        </div>
                    </li>
                    <li class="c-menu__item crm_navi_icon_cont">
                        <a href="investment">
